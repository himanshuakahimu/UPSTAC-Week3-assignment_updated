...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests() {
        // Get all to be tested requests (with status INITIATED)
    ...
    public List<TestRequest> getForTester() {
        // Get the logged in user (tester) and return the test requests assigned to the user
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        try {
            // Get the logged in user (tester) and assign the test to the user
            User tester = userLoggedInService.getLoggedInUser();
    ...
    public TestRequest updateLabTest(@PathVariable Long id, @RequestBody CreateLabResult createLabResult) {
        try {
            // Get the logged in user (tester) and update the test request to add lab results
            User tester = userLoggedInService.getLoggedInUser();
